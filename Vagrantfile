...
#  chef.chef_server_url = "https://api.chef.io/organizations/dlync"
#  chef.validation_key_path = "./.chef/dlync-validator.pem"
#  chef.validation_client_name = "dlync-validator"
